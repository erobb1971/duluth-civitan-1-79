    ...
    <footer className="bg-civitan-blue text-white pt-12 pb-20 lg:pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-civitan-gold">Contact</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-civitan-gold">Follow Us</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-civitan-gold">
